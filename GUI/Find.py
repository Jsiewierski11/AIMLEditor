...
https://github.com/goldsborough/Writer-Tutorial/blob/master/PyQt5/Part-3/ext/find.py
The code has been modified to work with this project 
but Goldsborough's tutorial and GitHub page were a huge help.
The tutorial for building the find dialog can be found here:
